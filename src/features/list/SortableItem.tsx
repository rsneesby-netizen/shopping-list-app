...
export function SortableItem({
  ...
  return (
    <li
      ...
      className={
        (inGroupedBlock
          ...
          : 'relative overflow-hidden rounded-[8px] bg-transparent dark:bg-transparent') +
    ...
    >
      ...
      <div
        className="relative z-10 flex h-8 items-center gap-[9px] bg-transparent py-0.5 transition-transform duration-75 dark:bg-transparent"
